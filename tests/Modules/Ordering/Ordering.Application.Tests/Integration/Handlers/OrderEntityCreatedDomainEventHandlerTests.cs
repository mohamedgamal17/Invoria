...
[TestFixture]
public class OrderEntityCreatedDomainEventHandlerTests
{
    ...
    public async Task Publishes_OrderCreatedIntegrationEvent()
    {
        ...
        var handler = new OrderEntityCreatedDomainEventHandler(
            bus.Object,
            Mock.Of<Microsoft.Extensions.Logging.ILogger<OrderEntityCreatedDomainEventHandler>>());
        ...
        var ev = new EntityCreatedDomainEvent<Order, string>(order);
