...
[TestFixture]
public class RejectPurchaseOrderEndpointTests : ProcurementTestFixture
{
    [Test]
    ...
    [Test]
    public async Task Should_return_domain_error_envelope_when_purchase_order_cannot_be_rejected()
    {
    ...
    private async Task<string> CreateDraftPurchaseOrderAsync()
    {
        var createSupplierRequest = new CreateSupplierRequest
        {
            ...
            Name = "Supplier for reject purchase order",
            ContactEmail = "reject-supplier@example.com",
            Phone = "+1"
        };
