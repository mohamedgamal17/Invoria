...
/// <summary>
/// Raised when a fulfillment dispatch completes and the fulfillment is marked completed.
/// </summary>
public sealed class FulfillmentCompletedDomainEvent : DomainEvent
{
    private FulfillmentCompletedDomainEvent(string fulfillmentId, string orderId, string allocationId)
    {
    ...
    public static FulfillmentCompletedDomainEvent ForFulfillment(Fulfillment fulfillment)
    {
        Guard.Against.Null(fulfillment);

        return new FulfillmentCompletedDomainEvent(
            fulfillment.Id!,
            fulfillment.OrderId,
