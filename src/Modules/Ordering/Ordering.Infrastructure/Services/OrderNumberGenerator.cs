...
namespace Invoria.Ordering.Infrastructure.Services
{
    public class OrderNumberGenerator : IOrderNumberGenerator
    {
        ...
        public OrderNumberGenerator(ICounterRepository counterRepository, Func<DateTime>? utcNowProvider = null)
        {
        ...
        public async Task<string> GenerateAsync(CancellationToken cancellationToken = default)
        {
            ...
            if (sequence > 9999)
            {
                throw new InvalidOperationException(
                    $"Daily order number limit exceeded for date {utcNow:yyMMdd}. Maximum allowed is 9999.");
            }
