...
public class ReopenOrderCommandHandler : IApplicatonRequestHandler<ReopenOrderCommand, OrderDto>
{
    ...
    public async Task<Result<OrderDto>> Handle(ReopenOrderCommand request, CancellationToken cancellationToken)
    {
