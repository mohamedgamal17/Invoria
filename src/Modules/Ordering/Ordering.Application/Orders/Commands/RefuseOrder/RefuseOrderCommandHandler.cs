...
public class RefuseOrderCommandHandler : IApplicatonRequestHandler<RefuseOrderCommand, OrderDto>
{
    private readonly IOrderingRepository<Order> _orderRepository;
    private readonly IOrderResponseFactory _orderResponseFactory;

    public RefuseOrderCommandHandler(
    ...
    public async Task<Result<OrderDto>> Handle(RefuseOrderCommand request, CancellationToken cancellationToken)
    {
