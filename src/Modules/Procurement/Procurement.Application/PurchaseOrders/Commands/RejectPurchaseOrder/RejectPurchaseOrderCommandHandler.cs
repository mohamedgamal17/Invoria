...
public sealed class RejectPurchaseOrderCommandHandler : IApplicatonRequestHandler<RejectPurchaseOrderCommand, PurchaseOrderDto>
{
    ...
    public async Task<Result<PurchaseOrderDto>> Handle(RejectPurchaseOrderCommand request, CancellationToken cancellationToken)
    {
        ...
        try
        {
            purchaseOrder.Reject(reason: null);
        }
